...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                // ExampleQuery::class,
                'lisOneTicket' => App\GraphQL\Queries\TicketQuery::class,
                'listAllTickets' => App\GraphQL\Queries\TicketsQuery::class,
            ],
            'mutation' => [
                // Crear un ticket
                'create' => App\GraphQL\Mutations\CreateTicket::class,
                // Actualizar un ticket
                'update' => App\GraphQL\Mutations\UpdateTicket::class,
                // Eliminar un ticket
                'delete' => App\GraphQL\Mutations\DeleteTicket::class,
            ],
            // The types only available in this schema
            'types' => [
                // ExampleType::class,
                'TypTic' => App\GraphQL\Types\TicketType::class,
            ],
